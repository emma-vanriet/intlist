...
public class intList {
	 ...
	 * @post The size of this list equals the old size plus one.
	 ...
	 * @post This list's elements at indices not less than the given index equal the old ones at index one greater.
	 ...
	 * | 0 <= index && index <= getSize()
	 * @past This list's size equals its old size plus one.
	 * | getSize() == old(getSize()) + 1
